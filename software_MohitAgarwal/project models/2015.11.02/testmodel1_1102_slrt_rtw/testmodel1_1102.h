...
#ifndef RTW_HEADER_testmodel1_1102_h_
#define RTW_HEADER_testmodel1_1102_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#include "rtw_modelmap.h"
#ifndef testmodel1_1102_COMMON_INCLUDES_
# define testmodel1_1102_COMMON_INCLUDES_
#include <string.h>
...
#endif                                 /* testmodel1_1102_COMMON_INCLUDES_ */

#include "testmodel1_1102_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_testmodel1_1102        RT_MODEL_testmodel1_1102_T

/* Definition for use in the target main file */
#define testmodel1_1102_rtModel        RT_MODEL_testmodel1_1102_T
...
typedef struct {
  CAN_DATATYPE Readv3_o1[50];          /* '<S8>/Read (v3)' */
  CAN_DATATYPE CANPack;                /* '<S12>/CAN Pack' */
  CAN_DATATYPE CANPack2;               /* '<S12>/CAN Pack2' */
  CAN_DATATYPE TmpSignalConversionAtWritev3Inp[2];
  CAN_DATATYPE IndexVector;            /* '<S13>/Index Vector' */
  CAN_DATATYPE CANPack_o;              /* '<S7>/CAN Pack' */
  CAN_DATATYPE CANPack_e;              /* '<S6>/CAN Pack' */
  CAN_DATATYPE CANPack_j;              /* '<S5>/CAN Pack' */
  CAN_DATATYPE CANPack2_b;             /* '<S4>/CAN Pack2' */
  CAN_DATATYPE CANPack1;               /* '<S3>/CAN Pack1' */
  CAN_DATATYPE CANPack_jw;             /* '<S3>/CAN Pack' */
  ...
  real_T Step3;                        /* '<S1>/Step3' */
  real_T Step;                         /* '<S1>/Step' */
  real_T Readv3_o2;                    /* '<S8>/Read (v3)' */
  ...
  real_T Constant1_n;                  /* '<S4>/Constant1' */
  real_T Constant_dc;                  /* '<S3>/Constant' */
  int8_T ForIterator;                  /* '<S13>/For Iterator' */
  uint8_T BitwiseOperator;             /* '<S4>/Bitwise Operator' */
} B_testmodel1_1102_T;
...
typedef struct {
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_l;                 /* '<S15>/S-Function' */

  int_T Readv3_IWORK[3];               /* '<S8>/Read (v3)' */
  int_T CANPack_ModeSignalID;          /* '<S12>/CAN Pack' */
  int_T CANPack2_ModeSignalID;         /* '<S12>/CAN Pack2' */
  int_T Writev3_IWORK[4];              /* '<S12>/Write (v3)' */
  struct {
    int_T AcquireOK;
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_j;                 /* '<S17>/S-Function' */
  ...
  int_T CANPack_ModeSignalID_m;        /* '<S7>/CAN Pack' */
  int_T Writev3_IWORK_e[4];            /* '<S7>/Write (v3)' */
  int_T CANPack_ModeSignalID_e;        /* '<S6>/CAN Pack' */
  int_T Writev3_IWORK_d[4];            /* '<S6>/Write (v3)' */
  int_T CANPack_ModeSignalID_m4;       /* '<S5>/CAN Pack' */
  int_T Writev3_IWORK_k[4];            /* '<S5>/Write (v3)' */
  int_T CANPack2_ModeSignalID_h;       /* '<S4>/CAN Pack2' */
  int_T Writev3_IWORK_p[4];            /* '<S4>/Write (v3)' */
  int_T CANPack1_ModeSignalID;         /* '<S3>/CAN Pack1' */
  int_T CANPack_ModeSignalID_b;        /* '<S3>/CAN Pack' */
  int_T Writev3_IWORK_l[4];            /* '<S3>/Write (v3)' */
  int8_T Velocitycontrol_SubsysRanBC;  /* '<S1>/Velocity control' */
  int8_T DefaultConfig_SubsysRanBC;    /* '<S1>/DefaultConfig' */
  int8_T GetState1ms_SubsysRanBC;      /* '<S1>/GetState1ms' */
  int8_T PositionControl_SubsysRanBC;  /* '<S1>/PositionControl ' */
  int8_T PositionControl1_SubsysRanBC; /* '<S1>/PositionControl 1' */
  int8_T QuitError_SubsysRanBC;        /* '<S1>/QuitError' */
  int8_T ForIteratorSubsystem_SubsysRanB;/* '<S8>/For Iterator Subsystem' */
} DW_testmodel1_1102_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Velocitycontrol_Trig_ZCE; /* '<S1>/Velocity control' */
  ZCSigState QuitError_Trig_ZCE;       /* '<S1>/QuitError' */
  ZCSigState PositionControl1_Trig_ZCE;/* '<S1>/PositionControl 1' */
  ZCSigState PositionControl_Trig_ZCE; /* '<S1>/PositionControl ' */
  ZCSigState GetState1ms_Trig_ZCE;     /* '<S1>/GetState1ms' */
  ZCSigState DefaultConfig_Trig_ZCE;   /* '<S1>/DefaultConfig' */
} PrevZCX_testmodel1_1102_T;

/* Backward compatible GRT Identifiers */
#define rtB                            testmodel1_1102_B
#define BlockIO                        B_testmodel1_1102_T
#define rtP                            testmodel1_1102_P
#define Parameters                     P_testmodel1_1102_T
#define rtDWork                        testmodel1_1102_DW
#define D_Work                         DW_testmodel1_1102_T
#define rtPrevZCSigState               testmodel1_1102_PrevZCX
#define PrevZCSigStates                PrevZCX_testmodel1_1102_T

/* Parameters (auto storage) */
struct P_testmodel1_1102_T_ {
  ...
  real_T Constant2_Value_d;            /* Expression: hex2dec('B0')
                                        ...
                                        */
  real_T Constant5_Value_k;            /* Expression: 20000
  ...
  real_T Out1_Y0;                      /* Computed Parameter: Out1_Y0
                                        * Referenced by: '<S13>/Out 1'
                                        */
  real_T Out2_Y0;                      /* Computed Parameter: Out2_Y0
                                        * Referenced by: '<S13>/Out 2'
                                        */
  real_T Constant1_Value_ml;           /* Expression: 5
                                        * Referenced by: '<S12>/Constant1'
                                        */
  real_T Constant2_Value_n0;           /* Expression: hex2dec('B5')
  ...
  real_T Setupv3_P11;                  /* Expression: pciSlot
                                        * Referenced by: '<S1>/Setup (v3)'
                                        */
  real_T Step4_Time;                   /* Expression: 30
  ...
  real_T PulseGenerator_PhaseDelay;    /* Expression: 10
                                        * Referenced by: '<S1>/Pulse Generator'
                                        */
  real_T Step5_Time;                   /* Expression: 40
  ...
  real_T Step1_YFinal;                 /* Expression: 0
                                        * Referenced by: '<S1>/Step1'
                                        */
  real_T Step2_Time;                   /* Expression: 8
  ...
  uint8_T position_Value;              /* Computed Parameter: position_Value
                                        ...
                                        */
  uint8_T velocity_Value;              /* Computed Parameter: velocity_Value
                                        * Referenced by: '<S4>/velocity'
                                        */
  uint8_T current_Value;               /* Computed Parameter: current_Value
                                        * Referenced by: '<S4>/current'
                                        */
  uint8_T position_Value_m;            /* Computed Parameter: position_Value_m
                                        * Referenced by: '<S12>/position'
                                        */
};

/* Real-time Model Data Structure */
struct tag_RTM_testmodel1_1102_T {
  const char_T *path;
...
extern P_testmodel1_1102_T testmodel1_1102_P;

/* Block signals (auto storage) */
extern B_testmodel1_1102_T testmodel1_1102_B;

/* Block states (auto storage) */
extern DW_testmodel1_1102_T testmodel1_1102_DW;

/* External data declarations for dependent source files */

/* Zero-crossing (trigger) state */
extern PrevZCX_testmodel1_1102_T testmodel1_1102_PrevZCX;

/*====================*
 * External functions *
 *====================*/
extern testmodel1_1102_rtModel *testmodel1_1102(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  testmodel1_1102_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_testmodel1_1102_T *const testmodel1_1102_M;
 ...
 *
 * '<Root>' : 'testmodel1_1102'
 * '<S1>'   : 'testmodel1_1102/IO601'
 * '<S2>'   : 'testmodel1_1102/info'
 * '<S3>'   : 'testmodel1_1102/IO601/DefaultConfig'
 * '<S4>'   : 'testmodel1_1102/IO601/GetState1ms'
 * '<S5>'   : 'testmodel1_1102/IO601/PositionControl '
 * '<S6>'   : 'testmodel1_1102/IO601/PositionControl 1'
 * '<S7>'   : 'testmodel1_1102/IO601/QuitError'
 * '<S8>'   : 'testmodel1_1102/IO601/ReadQueueSS'
 * '<S9>'   : 'testmodel1_1102/IO601/Scope '
 * '<S10>'  : 'testmodel1_1102/IO601/Scope (xPC) 1'
 * '<S11>'  : 'testmodel1_1102/IO601/Scope (xPC) 2'
 * '<S12>'  : 'testmodel1_1102/IO601/Velocity control'
 * '<S13>'  : 'testmodel1_1102/IO601/ReadQueueSS/For Iterator Subsystem'
 * '<S14>'  : 'testmodel1_1102/IO601/ReadQueueSS/Scope 1'
 * '<S15>'  : 'testmodel1_1102/IO601/ReadQueueSS/Scope 2'
 * '<S16>'  : 'testmodel1_1102/IO601/ReadQueueSS/For Iterator Subsystem/Scope 1'
 * '<S17>'  : 'testmodel1_1102/IO601/ReadQueueSS/For Iterator Subsystem/Scope 2'
 * '<S18>'  : 'testmodel1_1102/IO601/Velocity control/MATLAB Function'
 */
#endif                                 /* RTW_HEADER_testmodel1_1102_h_ */

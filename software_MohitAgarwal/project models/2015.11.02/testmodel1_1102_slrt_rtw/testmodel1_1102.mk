...
MODEL           = testmodel1_1102
MODULES         = can_datatype_ground.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c rtw_modelmap_utils.c testmodel1_1102_capi.c testmodel1_1102_data.c xpc_datatype_ground.c 
MAKEFILE        = testmodel1_1102.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\1SMARTe\Desktop\TESTMO~1\mohit\201511~1.02
S_FUNCTIONS     = sg_IO601_write_s_3.c sg_IO601_setup_s_3.c sg_IO601_read_s_3.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 0
...
MODELLIB                  = testmodel1_1102lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = testmodel1_1102_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\testmodel1_1102_slrt_rtw
...
LDFLAGS = /NOLOGO /DLL /SUBSYSTEM:CONSOLE /DEF:xpcvcdll.def $(EXT_LIB) /Include:_malloc /MAP
...
{$(MATLAB_ROOT)\simulink\src}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\can}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
...
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\can}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

...
typedef struct {
  ...
  CAN_DATATYPE IndexVector;            /* '<S26>/Index Vector' */
  CAN_DATATYPE CANPack;                /* '<S25>/CAN Pack' */
  CAN_DATATYPE CANPack_e;              /* '<S24>/CAN Pack' */
  CAN_DATATYPE CANPack2;               /* '<S23>/CAN Pack2' */
  CAN_DATATYPE CANPack1;               /* '<S4>/CAN Pack1' */
  CAN_DATATYPE CANPack_j;              /* '<S4>/CAN Pack' */
  CAN_DATATYPE TmpSignalConversionAtWritev3Inp[2];
  CAN_DATATYPE CANPack1_n;             /* '<S19>/CAN Pack1' */
  CAN_DATATYPE CANPack2_j;             /* '<S19>/CAN Pack2' */
  CAN_DATATYPE TmpSignalConversionAtWritev3I_j[2];/* '<S3>/movVel' */
  CAN_DATATYPE CANPack2_p;             /* '<S17>/CAN Pack2' */
  CAN_DATATYPE CANPack2_e;             /* '<S14>/CAN Pack2' */
  real_T Clock;                        /* '<S1>/Clock' */
  real_T Step4;                        /* '<S1>/Step4' */
  real_T PulseGenerator;               /* '<S1>/Pulse Generator' */
  real_T Product;                      /* '<S1>/Product' */
  real_T Counter_o1;                   /* '<S1>/Counter' */
  real_T Readv3_o2;                    /* '<S1>/Read (v3)' */
  real_T PulseGenerator1;              /* '<S1>/Pulse Generator1' */
  real_T Counter1_o1;                  /* '<S1>/Counter1' */
  real_T Subtract;                     /* '<S1>/Subtract' */
  real_T TransportDelay;               /* '<S1>/Transport Delay' */
  real_T Step5;                        /* '<S1>/Step5' */
  real_T Uk1;                          /* '<S5>/Delay Input1' */
  real_T PulseGenerator2;              /* '<S1>/Pulse Generator2' */
  real_T Step1;                        /* '<S1>/Step1' */
  real_T Step1_b;                      /* '<S6>/Step1' */
  real_T Step3;                        /* '<S6>/Step3' */
  real_T Step;                         /* '<S6>/Step' */
  real_T CANUnpack1_o1;                /* '<S28>/CAN Unpack1' */
  real_T CANUnpack1_o2;                /* '<S28>/CAN Unpack1' */
  real_T CANUnpack1_o3;                /* '<S28>/CAN Unpack1' */
  real_T CANUnpack1_o4;                /* '<S28>/CAN Unpack1' */
  real_T Uk1_k;                        /* '<S29>/Delay Input1' */
  real_T Counter_o1_i;                 /* '<S28>/Counter' */
  real_T DataTypeConversion;           /* '<S28>/Data Type Conversion' */
  real_T Constant1;                    /* '<S25>/Constant1' */
  real_T Constant;                     /* '<S24>/Constant' */
  real_T Constant1_n;                  /* '<S23>/Constant1' */
  real_T Constant_d;                   /* '<S4>/Constant' */
  real_T Product2;                     /* '<S3>/Product2' */
  real_T Product_b;                    /* '<S3>/Product' */
  int32_T DataTypeConversion_m;        /* '<S1>/Data Type Conversion' */
  ...
  int32_T state[2];                    /* '<S26>/MATLAB Function1' */
  int32_T vel;                         /* '<S19>/MATLAB Function1' */
  int32_T y;                           /* '<S3>/MATLAB Function' */
  uint32_T cur;                        /* '<S19>/MATLAB Function1' */
  int32_T DiscreteTimeIntegrator;      /* '<S1>/Discrete-Time Integrator' */
  int8_T ForIterator;                  /* '<S26>/For Iterator' */
  uint8_T FixPtRelationalOperator;     /* '<S5>/FixPt Relational Operator' */
  uint8_T CANUnpack2[8];               /* '<S26>/CAN Unpack2' */
  uint8_T CANUnpack3[7];               /* '<S26>/CAN Unpack3' */
  uint8_T y_e[4];                      /* '<S19>/TC UI32-UI8' */
  boolean_T Counter_o2;                /* '<S1>/Counter' */
  boolean_T Counter1_o2;               /* '<S1>/Counter1' */
  boolean_T FixPtRelationalOperator_k; /* '<S29>/FixPt Relational Operator' */
  boolean_T Counter_o2_i;              /* '<S28>/Counter' */
  boolean_T TmpLatchAtJKFlipFlopInport1;
  boolean_T TmpLatchAtJKFlipFlopInport2;
  boolean_T HiddenBuf_InsertedFor_JKFlipFlo;
...
typedef struct {
  ...
  real_T DelayInput1_DSTATE_h;         /* '<S29>/Delay Input1' */
  real_T pos[4];                       /* '<S26>/MATLAB Function1' */
  real_T vel[4];                       /* '<S26>/MATLAB Function1' */
  struct {
    real_T modelTStart;
  ...
  int32_T clockTickCounter_g;          /* '<S1>/Pulse Generator1' */
  int32_T clockTickCounter_c;          /* '<S1>/Pulse Generator2' */
  uint32_T Counter_ClkEphState;        /* '<S1>/Counter' */
  uint32_T Counter1_ClkEphState;       /* '<S1>/Counter1' */
  uint32_T Counter1_RstEphState;       /* '<S1>/Counter1' */
  uint32_T Counter_Count;              /* '<S28>/Counter' */
  uint32_T Counter_ClkEphState_g;      /* '<S28>/Counter' */
  uint32_T Counter_RstEphState;        /* '<S28>/Counter' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_c;                 /* '<S9>/S-Function' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_bv;                /* '<S12>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_oz;                /* '<S13>/S-Function' */
  ...
  int_T CANUnpack2_ModeSignalID;       /* '<S26>/CAN Unpack2' */
  int_T CANUnpack2_StatusPortID;       /* '<S26>/CAN Unpack2' */
  int_T CANUnpack3_ModeSignalID;       /* '<S26>/CAN Unpack3' */
  int_T CANUnpack3_StatusPortID;       /* '<S26>/CAN Unpack3' */
  struct {
    int_T AcquireOK;
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_h;                 /* '<S31>/S-Function' */

  int_T CANUnpack1_ModeSignalID;       /* '<S28>/CAN Unpack1' */
  int_T CANUnpack1_StatusPortID;       /* '<S28>/CAN Unpack1' */
  int_T CANPack_ModeSignalID;          /* '<S25>/CAN Pack' */
  int_T Writev3_IWORK[4];              /* '<S25>/Write (v3)' */
  int_T CANPack_ModeSignalID_e;        /* '<S24>/CAN Pack' */
  int_T Writev3_IWORK_d[4];            /* '<S24>/Write (v3)' */
  int_T CANPack2_ModeSignalID;         /* '<S23>/CAN Pack2' */
  int_T Writev3_IWORK_p[4];            /* '<S23>/Write (v3)' */
  ...
  int_T CANPack1_ModeSignalID_c;       /* '<S19>/CAN Pack1' */
  int_T CANPack2_ModeSignalID_p;       /* '<S19>/CAN Pack2' */
  int_T Writev3_IWORK_d5[4];           /* '<S3>/Write (v3)' */
  int_T CANPack2_ModeSignalID_j;       /* '<S17>/CAN Pack2' */
  int_T Writev31_IWORK[4];             /* '<S3>/Write (v3)1' */
  int_T CANPack2_ModeSignalID_k;       /* '<S14>/CAN Pack2' */
  uint16_T Counter_Count_p;            /* '<S1>/Counter' */
  uint16_T Counter1_Count;             /* '<S1>/Counter1' */
  int8_T CANSend_SubsysRanBC;          /* '<S1>/CANSend' */
  ...
  int8_T JKFlipFlop_SubsysRanBC;       /* '<S15>/J-K Flip-Flop' */
...
typedef struct {
  ...
  ZCSigState CANSend_Trig_ZCE;         /* '<S1>/CANSend' */
  ZCSigState JKFlipFlop_Trig_ZCE;      /* '<S15>/J-K Flip-Flop' */
...
struct P_testmodel_1109_T_ {
  ...
  real_T DetectIncrease_vinit;         /* Mask Parameter: DetectIncrease_vinit
                                        ...
                                        */
  real_T DetectIncrease_vinit_k;       /* Mask Parameter: DetectIncrease_vinit_k
                                        * Referenced by: '<S5>/Delay Input1'
                                        */
  uint32_T Counter_HitValue;           /* Mask Parameter: Counter_HitValue
                                        * Referenced by: '<S28>/Counter'
                                        */
  uint32_T Counter_InitialCount;       /* Mask Parameter: Counter_InitialCount
                                        * Referenced by: '<S28>/Counter'
                                        */
  uint16_T Counter_HitValue_e;         /* Mask Parameter: Counter_HitValue_e
                                        * Referenced by: '<S1>/Counter'
                                        */
  uint16_T Counter1_HitValue;          /* Mask Parameter: Counter1_HitValue
                                        * Referenced by: '<S1>/Counter1'
                                        */
  uint16_T Counter_InitialCount_h;     /* Mask Parameter: Counter_InitialCount_h
                                        * Referenced by: '<S1>/Counter'
                                        */
  ...
  real_T FragEn_Value;                 /* Expression: hex2dec('86')
                                        ...
                                        */
  real_T SendVel_Value;                /* Expression: 2
  ...
  real_T PulseGenerator1_Duty;         /* Computed Parameter: PulseGenerator1_Duty
                                        * Referenced by: '<S1>/Pulse Generator1'
                                        */
  real_T PulseGenerator1_PhaseDelay;   /* Expression: 10
                                        * Referenced by: '<S1>/Pulse Generator1'
                                        */
  ...
  real_T PulseGenerator2_Duty;         /* Computed Parameter: PulseGenerator2_Duty
                                        * Referenced by: '<S1>/Pulse Generator2'
                                        */
  real_T PulseGenerator2_PhaseDelay;   /* Expression: 10
                                        * Referenced by: '<S1>/Pulse Generator2'
                                        */
 ...
 * '<S5>'   : 'testmodel_1109/IO601/Detect Increase'
 ...
 * '<S11>'  : 'testmodel_1109/IO601/Scope 3'
 * '<S12>'  : 'testmodel_1109/IO601/Scope 4'
 * '<S13>'  : 'testmodel_1109/IO601/Scope 5'
 * '<S14>'  : 'testmodel_1109/IO601/CANSend/GetState (once)'
 * '<S15>'  : 'testmodel_1109/IO601/CANSend/J-K Flip-Flop1'
 * '<S16>'  : 'testmodel_1109/IO601/CANSend/MATLAB Function'
 * '<S17>'  : 'testmodel_1109/IO601/CANSend/STOP'
 * '<S18>'  : 'testmodel_1109/IO601/CANSend/Scope '
 * '<S19>'  : 'testmodel_1109/IO601/CANSend/movVel'
 * '<S20>'  : 'testmodel_1109/IO601/CANSend/J-K Flip-Flop1/J-K Flip-Flop'
 * '<S21>'  : 'testmodel_1109/IO601/CANSend/movVel/MATLAB Function1'
 * '<S22>'  : 'testmodel_1109/IO601/CANSend/movVel/TC UI32-UI8'
 * '<S23>'  : 'testmodel_1109/IO601/Initialize/GetState(ms)'
 * '<S24>'  : 'testmodel_1109/IO601/Initialize/InitialPosition'
 * '<S25>'  : 'testmodel_1109/IO601/Initialize/QuitError'
 * '<S26>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem'
 * '<S27>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/MATLAB Function1'
 * '<S28>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/ReadACK'
 * '<S29>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/ReadACK/Detect Increase'
 * '<S30>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/ReadACK/Scope 1'
 * '<S31>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/ReadACK/Scope 3'
 */

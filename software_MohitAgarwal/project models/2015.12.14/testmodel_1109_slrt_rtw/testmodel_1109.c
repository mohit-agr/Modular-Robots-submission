...
uint32_T MWDSP_EPH_R_B(boolean_T evt, uint32_T *sta)
{
  ...
  /* S-Function (sdspcount2): '<S21>/Counter1' */
  ...
  /* End of S-Function (sdspcount2): '<S21>/Counter1' */
  return retVal;
}
...
static void testmodel_1109_output(void)
{
   ...
   */
  zcEvent = ((!testmodel_1109_B.Memory) &&
             (testmodel_1109_PrevZCX.JKFlipFlop_Trig_ZCE != ZERO_ZCSIG));
  if (zcEvent) {
    /* Memory: '<S20>/Memory' */
    testmodel_1109_B.Memory_m = testmodel_1109_DW.Memory_PreviousInput_h;

    /* CombinatorialLogic: '<S20>/Logic' */
    zcEvent = testmodel_1109_B.Memory_m;
    c1 = zcEvent;
    zcEvent = testmodel_1109_B.TmpLatchAtJKFlipFlopInport1;
    c1 = (int32_T)(((uint32_T)c1 << 1) + zcEvent);
    zcEvent = testmodel_1109_B.TmpLatchAtJKFlipFlopInport2;
    c1 = (int32_T)(((uint32_T)c1 << 1) + zcEvent);
    ...
    testmodel_1109_DW.Memory_PreviousInput_h = testmodel_1109_B.Logic[0];
    testmodel_1109_DW.JKFlipFlop_SubsysRanBC = 4;
  }

  testmodel_1109_PrevZCX.JKFlipFlop_Trig_ZCE = testmodel_1109_B.Memory;
  ...
  testmodel_1109_B.DataTypeConversion4 = testmodel_1109_B.OutportBufferForQ;
  ...
  testmodel_1109_B.Product = testmodel_1109_B.Step4 *
    testmodel_1109_B.DataTypeConversion4 * testmodel_1109_B.PulseGenerator;
  ...
  do {
    ...
    if (s8_iter <= (currentTime < 0.0 ? (int32_T)(int8_T)-(int8_T)(uint8_T)
      ...
      if (MWDSP_EPH_R_D(testmodel_1109_B.Product1[0],
      ...
      if (MWDSP_EPH_R_D(testmodel_1109_B.Product1[1],
                        &testmodel_1109_DW.Counter1_ClkEphState) != 0U) {
        if (testmodel_1109_DW.Counter1_Count < ((uint16_T)5000U)) {
          testmodel_1109_DW.Counter1_Count++;
        } else {
      ...
      testmodel_1109_B.DataTypeConversion1 = testmodel_1109_B.Counter1_o2;

      /* MATLAB Function 'IO601/ReadQueueSS/MATLAB Function1': '<S22>:1' */
...
static void testmodel_1109_update(void)
{
  ...
  testmodel_1109_DW.Memory_PreviousInput = testmodel_1109_B.Counter1_o2;
...
static void testmodel_1109_initialize(void)
{
  ...
  testmodel_1109_B.Counter1_o2 = testmodel_1109_P.STOP_Y0;
  ...
  testmodel_1109_DW.Memory_PreviousInput = testmodel_1109_P.Memory_X0_e;

  /* InitializeConditions for Triggered SubSystem: '<S7>/J-K Flip-Flop' */
  /* InitializeConditions for Memory: '<S20>/Memory' */
  testmodel_1109_DW.Memory_PreviousInput_h = testmodel_1109_P.Memory_X0;
...
RT_MODEL_testmodel_1109_T *testmodel_1109(void)
{
  ...
  testmodel_1109_M->Sizes.numBlockIO = (60);/* Number of block outputs */
  testmodel_1109_M->Sizes.numBlockPrms = (316);/* Sum of parameter "widths" */

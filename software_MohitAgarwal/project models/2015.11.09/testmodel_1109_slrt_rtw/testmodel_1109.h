...
typedef struct {
  CAN_DATATYPE Readv3_o1[4];           /* '<S8>/Read (v3)' */
  CAN_DATATYPE CANPack;                /* '<S12>/CAN Pack' */
  CAN_DATATYPE CANPack1;               /* '<S12>/CAN Pack1' */
  CAN_DATATYPE CANPack2;               /* '<S12>/CAN Pack2' */
  CAN_DATATYPE TmpSignalConversionAtWritev3Inp[3];
  CAN_DATATYPE CANPack2_p;             /* '<S9>/CAN Pack2' */
  CAN_DATATYPE IndexVector;            /* '<S14>/Index Vector' */
  ...
  CAN_DATATYPE CANPack1_m;             /* '<S3>/CAN Pack1' */
  ...
  real_T Product_l;                    /* '<S9>/Product' */
  real_T noAck;                        /* '<S8>/MATLAB Function' */
  real_T CANUnpack_o1;                 /* '<S14>/CAN Unpack' */
  real_T CANUnpack_o2;                 /* '<S14>/CAN Unpack' */
  real_T CANUnpack_o3;                 /* '<S14>/CAN Unpack' */
  real_T CANUnpack1_o1;                /* '<S14>/CAN Unpack1' */
  real_T CANUnpack1_o2;                /* '<S14>/CAN Unpack1' */
  real_T CANUnpack1_o3;                /* '<S14>/CAN Unpack1' */
  ...
  int8_T ForIterator;                  /* '<S14>/For Iterator' */
  uint8_T cur[8];                      /* '<S12>/MATLAB Function' */
...
typedef struct {
  ...
  uint32_T FixPtSum1_DWORK1;           /* '<S17>/FixPt Sum1' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_j;                 /* '<S11>/S-Function' */
  ...
  int_T CANPack1_ModeSignalID;         /* '<S12>/CAN Pack1' */
  int_T CANPack2_ModeSignalID;         /* '<S12>/CAN Pack2' */
  int_T Writev3_IWORK[4];              /* '<S12>/Write (v3)' */
  int_T CANPack2_ModeSignalID_j;       /* '<S9>/CAN Pack2' */
  int_T Writev3_IWORK_p[4];            /* '<S9>/Write (v3)' */
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_o;                 /* '<S19>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_f;                 /* '<S20>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_h;                 /* '<S21>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_he;                /* '<S22>/S-Function' */

  int_T CANUnpack_ModeSignalID;        /* '<S14>/CAN Unpack' */
  int_T CANUnpack_StatusPortID;        /* '<S14>/CAN Unpack' */
  int_T CANUnpack1_ModeSignalID;       /* '<S14>/CAN Unpack1' */
  int_T CANUnpack1_StatusPortID;       /* '<S14>/CAN Unpack1' */
  ...
  int_T Writev3_IWORK_pr[4];           /* '<S4>/Write (v3)' */
  int_T CANPack1_ModeSignalID_n;       /* '<S3>/CAN Pack1' */
 ...
 * '<S3>'   : 'testmodel_1109/IO601/DefaultConfig'
 * '<S4>'   : 'testmodel_1109/IO601/GetState1ms'
 * '<S5>'   : 'testmodel_1109/IO601/PositionControl '
 * '<S6>'   : 'testmodel_1109/IO601/PositionControl 1'
 * '<S7>'   : 'testmodel_1109/IO601/QuitError'
 * '<S8>'   : 'testmodel_1109/IO601/ReadQueueSS'
 * '<S9>'   : 'testmodel_1109/IO601/STOP'
 * '<S10>'  : 'testmodel_1109/IO601/Scope '
 * '<S11>'  : 'testmodel_1109/IO601/Scope 1'
 * '<S12>'  : 'testmodel_1109/IO601/Velocity control'
 * '<S13>'  : 'testmodel_1109/IO601/ReadQueueSS/Counter Free-Running'
 * '<S14>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem'
 * '<S15>'  : 'testmodel_1109/IO601/ReadQueueSS/MATLAB Function'
 * '<S16>'  : 'testmodel_1109/IO601/ReadQueueSS/Scope 2'
 * '<S17>'  : 'testmodel_1109/IO601/ReadQueueSS/Counter Free-Running/Increment Real World'
 * '<S18>'  : 'testmodel_1109/IO601/ReadQueueSS/Counter Free-Running/Wrap To Zero'
 * '<S19>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/Scope '
 * '<S20>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/Scope 1'
 * '<S21>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/Scope 2'
 * '<S22>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/Scope 3'
 * '<S23>'  : 'testmodel_1109/IO601/Velocity control/MATLAB Function'
 * '<S24>'  : 'testmodel_1109/IO601/Velocity control/Scope 2'
 * '<S25>'  : 'testmodel_1109/IO601/Velocity control/Scope 3'
 */

...
static const char * c2_debug_family_names[7] = { "c", "c1", "nargin", "nargout",
  "time", "vel", "cur" };
...
static void c2_emlrt_marshallIn(SFc2_testmodel_1109InstanceStruct *chartInstance,
  const mxArray *c2_b_cur, const char_T *c2_identifier, uint8_T c2_y[8]);
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_testmodel_1109InstanceStruct
  *chartInstance, const mxArray *c2_b_vel, const char_T *c2_identifier);
static real_T c2_d_emlrt_marshallIn(SFc2_testmodel_1109InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_testmodel_1109InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_testmodel_1109InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_testmodel_1109, const char_T *
  c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_testmodel_1109InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
  ...
  (SFc2_testmodel_1109InstanceStruct *chartInstance)
{
  ...
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", *chartInstance->c2_cur, 3, 0U, 1U,
    0U, 2, 1, 8), false);
  sf_mex_setcell(c2_y, 0, c2_b_y);
  c2_hoistedGlobal = *chartInstance->c2_vel;
  c2_u = c2_hoistedGlobal;
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_y, 1, c2_c_y);
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_testmodel_1109;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell("cur", c2_u, 0)),
                      "cur", c2_uv0);
  for (c2_i0 = 0; c2_i0 < 8; c2_i0++) {
    (*chartInstance->c2_cur)[c2_i0] = c2_uv0[c2_i0];
  }

  *chartInstance->c2_vel = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell("vel", c2_u, 1)), "vel");
  chartInstance->c2_is_active_c2_testmodel_1109 = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c2_testmodel_1109",
       c2_u, 2)), "is_active_c2_testmodel_1109");
  sf_mex_destroy(&c2_u);
  ...
  *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_time, 0U, 1U, 0U,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c, 0U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c1, 1U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 3U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_time, 4U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_vel, 5U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_b_cur, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 4);
  c2_b_vel = 15000.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 5);
  c2_A = 6.2831853071795862 * c2_b_time;
  c2_x = c2_A;
  c2_b_x = c2_x;
  c2_y = c2_b_x / 10.0;
  c2_c_x = c2_y;
  ...
  c2_g_x = c2_c1;
  c2_c1 = c2_g_x;
  c2_c1 = muDoubleScalarFloor(c2_c1);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 8);
  c2_h_x = c2_c1;
  memcpy(&c2_b_cur[0], &c2_h_x, (size_t)8 * sizeof(uint8_T));
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -8);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c2_vel = c2_b_vel;
  for (c2_i1 = 0; c2_i1 < 8; c2_i1++) {
    (*chartInstance->c2_cur)[c2_i1] = c2_b_cur[c2_i1];
  }
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_vel, 1U, 1U, 0U,
                        chartInstance->c2_sfEvent, false);
  for (c2_i2 = 0; c2_i2 < 8; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c2_cur)[c2_i2], 2U, 1U, 0U,
                          chartInstance->c2_sfEvent, false);
  }
}
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  for (c2_i3 = 0; c2_i3 < 8; c2_i3++) {
    c2_u[c2_i3] = (*(uint8_T (*)[8])c2_inData)[c2_i3];
  }

  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 3, 0U, 1U, 0U, 2, 1, 8), false);
  ...
  const mxArray *c2_b_cur, const char_T *c2_identifier, uint8_T c2_y[8])
{
  ...
  c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_cur), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_b_cur);
}
  ...
  uint8_T c2_y[8])
{
  ...
  int32_T c2_i4;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_uv1, 1, 3, 0U, 1, 0U, 2, 1, 8);
  for (c2_i4 = 0; c2_i4 < 8; c2_i4++) {
    c2_y[c2_i4] = c2_uv1[c2_i4];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_testmodel_1109InstanceStruct *chartInstance;
  chartInstance = (SFc2_testmodel_1109InstanceStruct *)chartInstanceVoid;
  c2_b_cur = sf_mex_dup(c2_mxArrayInData);
  ...
  for (c2_i5 = 0; c2_i5 < 8; c2_i5++) {
    (*(uint8_T (*)[8])c2_outData)[c2_i5] = c2_y[c2_i5];
  }
  ...
  *chartInstance, const mxArray *c2_b_vel, const char_T *c2_identifier)
{
  ...
  c2_thisId.fParent = NULL;
  c2_thisId.bParentIsCell = false;
  c2_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_vel), &c2_thisId);
  ...
  *chartInstance)
{
  chartInstance->c2_time = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_vel = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_cur = (uint8_T (*)[8])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(319981722U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(707050941U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(978196789U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3508599971U);
}
...
mxArray *sf_c2_testmodel_1109_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("uNsYpCxIj8gcJVIO7fl7wH");
...
static const mxArray *sf_get_sim_state_info_c2_testmodel_1109(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[7],T\"cur\",},{M[1],M[6],T\"vel\",},{M[8],M[0],T\"is_active_c2_testmodel_1109\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"vel");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c2_vel);
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c2_cur);
      }
    }
  }
}
...
{
  return "s5aAFCh0LFVXsjkhDge9jfE";
}
...
static void mdlSetWorkWidths_c2_testmodel_1109(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(346241504U));
  ssSetChecksum1(S,(36611192U));
  ssSetChecksum2(S,(826333895U));
  ssSetChecksum3(S,(3667537367U));

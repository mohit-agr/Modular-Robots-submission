...
/* Block signals for system '<S7>/J-K Flip-Flop' */
typedef struct {
  boolean_T Memory;                    /* '<S20>/Memory' */
  boolean_T Logic[2];                  /* '<S20>/Logic' */
  boolean_T OutportBufferForQ;
} B_JKFlipFlop_testmodel_1109_T;

/* Block states (auto storage) for system '<S7>/J-K Flip-Flop' */
typedef struct {
  int8_T JKFlipFlop_SubsysRanBC;       /* '<S7>/J-K Flip-Flop' */
  boolean_T Memory_PreviousInput;      /* '<S20>/Memory' */
} DW_JKFlipFlop_testmodel_1109_T;

/* Zero-crossing (trigger) state for system '<S7>/J-K Flip-Flop' */
typedef struct {
  ZCSigState JKFlipFlop_Trig_ZCE;      /* '<S7>/J-K Flip-Flop' */
} ZCE_JKFlipFlop_testmodel_1109_T;

/* Block signals (auto storage) */
typedef struct {
  CAN_DATATYPE Readv3_o1[40];          /* '<S1>/Read (v3)' */
  CAN_DATATYPE TmpSignalConversionAtWritev3Inp[3];/* '<S1>/CANSend' */
  ...
  real_T Writev3[3];                   /* '<S1>/Write (v3)' */
  real_T DataTypeConversion3[3];       /* '<S1>/Data Type Conversion3' */
  real_T Product1[3];                  /* '<S1>/Product1' */
  real_T Counter2_o1;                  /* '<S1>/Counter2' */
  ...
  real_T Uk1;                          /* '<S27>/Delay Input1' */
  real_T Counter1_o1_m;                /* '<S21>/Counter1' */
  real_T DataTypeConversion1;          /* '<S21>/Data Type Conversion1' */
  real_T Uk1_n;                        /* '<S22>/Delay Input1' */
  real_T Counter_o1;                   /* '<S8>/Counter' */
  real_T Counter1_o1_a;                /* '<S8>/Counter1' */
  real_T DataTypeConversion1_i;        /* '<S8>/Data Type Conversion1' */
  ...
  int32_T DataTypeConversion2_m;       /* '<S1>/Data Type Conversion2' */
  ...
  boolean_T Compare[3];                /* '<S4>/Compare' */
  boolean_T Counter2_o2;               /* '<S1>/Counter2' */
  boolean_T Counter1_o2;               /* '<S1>/Counter1' */
  boolean_T FixPtRelationalOperator;   /* '<S27>/FixPt Relational Operator' */
  boolean_T Counter1_o2_f;             /* '<S21>/Counter1' */
  boolean_T FixPtRelationalOperator_k; /* '<S22>/FixPt Relational Operator' */
  boolean_T Counter_o2;                /* '<S8>/Counter' */
  boolean_T TmpLatchAtJKFlipFlopInport1_m;
  boolean_T TmpLatchAtJKFlipFlopInport2_f;
  boolean_T Counter1_o2_b;             /* '<S8>/Counter1' */
  B_JKFlipFlop_testmodel_1109_T JKFlipFlop_l;/* '<S23>/J-K Flip-Flop' */
  B_JKFlipFlop_testmodel_1109_T JKFlipFlop;/* '<S7>/J-K Flip-Flop' */
} B_testmodel_1109_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T DelayInput1_DSTATE;           /* '<S27>/Delay Input1' */
  real_T DelayInput1_DSTATE_f;         /* '<S22>/Delay Input1' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_bi;                /* '<S11>/S-Function' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_e;                 /* '<S26>/S-Function' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_p;                 /* '<S28>/S-Function' */
  ...
  uint8_T Counter2_Count;              /* '<S1>/Counter2' */
  uint8_T Counter1_Count_o;            /* '<S1>/Counter1' */
  uint8_T Counter_Count;               /* '<S8>/Counter' */
  uint8_T Counter1_Count_m;            /* '<S8>/Counter1' */
  ...
  boolean_T TmpLatchAtJKFlipFlopInport1_P_c;/* synthesized block */
  boolean_T TmpLatchAtJKFlipFlopInport2_P_m;/* synthesized block */
  DW_JKFlipFlop_testmodel_1109_T JKFlipFlop_l;/* '<S23>/J-K Flip-Flop' */
  DW_JKFlipFlop_testmodel_1109_T JKFlipFlop;/* '<S7>/J-K Flip-Flop' */
} DW_testmodel_1109_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCE_JKFlipFlop_testmodel_1109_T JKFlipFlop_l;/* '<S7>/J-K Flip-Flop' */
  ZCE_JKFlipFlop_testmodel_1109_T JKFlipFlop;/* '<S7>/J-K Flip-Flop' */
...
/* Parameters for system: '<S7>/J-K Flip-Flop' */
struct P_JKFlipFlop_testmodel_1109_T_ {
...
struct P_testmodel_1109_T_ {
  real_T JKFlipFlop_initial_condition; /* Mask Parameter: JKFlipFlop_initial_condition
                                        ...
                                        */
  real_T JKFlipFlop_initial_condition_a;/* Mask Parameter: JKFlipFlop_initial_condition_a
  ...
  real_T DetectIncrease_vinit;         /* Mask Parameter: DetectIncrease_vinit
                                        ...
                                        */
  real_T DetectIncrease_vinit_e;       /* Mask Parameter: DetectIncrease_vinit_e
  ...
  uint8_T Counter_HitValue;            /* Mask Parameter: Counter_HitValue
                                        ...
                                        */
  uint8_T Counter1_HitValue_n;         /* Mask Parameter: Counter1_HitValue_n
                                        * Referenced by: '<S8>/Counter1'
                                        */
  uint8_T Counter2_HitValue;           /* Mask Parameter: Counter2_HitValue
                                        * Referenced by: '<S1>/Counter2'
                                        */
  uint8_T Counter1_HitValue_nf;        /* Mask Parameter: Counter1_HitValue_nf
                                        * Referenced by: '<S1>/Counter1'
                                        */
  uint8_T Counter_InitialCount;        /* Mask Parameter: Counter_InitialCount
                                        * Referenced by: '<S8>/Counter'
                                        */
  uint8_T Counter1_InitialCount_a;     /* Mask Parameter: Counter1_InitialCount_a
                                        * Referenced by: '<S8>/Counter1'
                                        */
  uint8_T Counter2_InitialCount;       /* Mask Parameter: Counter2_InitialCount
                                        * Referenced by: '<S1>/Counter2'
                                        */
  uint8_T Counter1_InitialCount_d;     /* Mask Parameter: Counter1_InitialCount_d
                                        * Referenced by: '<S1>/Counter1'
                                        */
  ...
  real_T Setupv3_P11;                  /* Expression: pciSlot
                                        * Referenced by: '<S1>/Setup (v3)'
                                        */
  real_T SendOut_Value;                /* Expression: 3
  ...
  boolean_T STOP_Y0;                   /* Computed Parameter: STOP_Y0
                                        ...
                                        */
  boolean_T ackrecd_Y0;                /* Computed Parameter: ackrecd_Y0
                                        * Referenced by: '<S8>/ackrecd'
                                        */
  boolean_T SendStop_Y0;               /* Computed Parameter: SendStop_Y0
  ...
  boolean_T TmpLatchAtJKFlipFlopInport2_X0;/* Computed Parameter: TmpLatchAtJKFlipFlopInport2_X0
                                            * Referenced by: synthesized block
                                            */
  boolean_T TmpLatchAtJKFlipFlopInport1_X_n;/* Computed Parameter: TmpLatchAtJKFlipFlopInport1_X_n
                                             * Referenced by: synthesized block
                                             */
  boolean_T TmpLatchAtJKFlipFlopInport2_X_n;/* Computed Parameter: TmpLatchAtJKFlipFlopInport2_X_n
                                             * Referenced by: synthesized block
                                             */
  boolean_T Memory_X0;                 /* Computed Parameter: Memory_X0
                                        * Referenced by: '<S1>/Memory'
                                        */
  P_JKFlipFlop_testmodel_1109_T JKFlipFlop_l;/* '<S23>/J-K Flip-Flop' */
  P_JKFlipFlop_testmodel_1109_T JKFlipFlop;/* '<S7>/J-K Flip-Flop' */
};
 ...
 * '<S22>'  : 'testmodel_1109/IO601/ReadQueueSS/Detect Increase'
 * '<S23>'  : 'testmodel_1109/IO601/ReadQueueSS/J-K Flip-Flop'
 * '<S24>'  : 'testmodel_1109/IO601/ReadQueueSS/MATLAB Function1'
 * '<S25>'  : 'testmodel_1109/IO601/ReadQueueSS/Scope 1'
 * '<S26>'  : 'testmodel_1109/IO601/ReadQueueSS/Scope 3'
 * '<S27>'  : 'testmodel_1109/IO601/ReadQueueSS/CountACK/Detect Increase'
 * '<S28>'  : 'testmodel_1109/IO601/ReadQueueSS/CountACK/Scope 3'
 * '<S29>'  : 'testmodel_1109/IO601/ReadQueueSS/J-K Flip-Flop/J-K Flip-Flop'
 */

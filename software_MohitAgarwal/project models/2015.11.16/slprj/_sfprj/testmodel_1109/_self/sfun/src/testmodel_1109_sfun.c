  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==3) {
    c3_testmodel_1109_method_dispatcher(simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==4) {
    c4_testmodel_1109_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
       ...
       case 3:
        {
          ...
          sf_c3_testmodel_1109_get_check_sum(plhs);
          break;
        }
       ...
       case 4:
        {
          ...
          sf_c4_testmodel_1109_get_check_sum(plhs);
          break;
        }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(aiChksum, "BumWa7qeM4vk9m0Mu2NzlH") == 0) {
          extern mxArray *sf_c3_testmodel_1109_get_autoinheritance_info(void);
          plhs[0] = sf_c3_testmodel_1109_get_autoinheritance_info();
          break;
        }
     ...
     case 4:
      {
        if (strcmp(aiChksum, "Fl7crw61umzFNnAgLyVf6G") == 0) {
          extern mxArray *sf_c4_testmodel_1109_get_autoinheritance_info(void);
          plhs[0] = sf_c4_testmodel_1109_get_autoinheritance_info();
          break;
        }
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        extern const mxArray
          *sf_c3_testmodel_1109_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c3_testmodel_1109_get_eml_resolved_functions_info();
     ...
     case 4:
      {
        extern const mxArray
          *sf_c4_testmodel_1109_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c4_testmodel_1109_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "sfwpEfgroDabeJuY5NfKlDH") == 0) {
          extern mxArray *sf_c3_testmodel_1109_third_party_uses_info(void);
          plhs[0] = sf_c3_testmodel_1109_third_party_uses_info();
          break;
        }
      }
     ...
     case 4:
      {
        if (strcmp(tpChksum, "sUYgwWq1d1sdy5xW3XbyWQH") == 0) {
          extern mxArray *sf_c4_testmodel_1109_third_party_uses_info(void);
          plhs[0] = sf_c4_testmodel_1109_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "sfwpEfgroDabeJuY5NfKlDH") == 0) {
          extern mxArray *sf_c3_testmodel_1109_jit_fallback_info(void);
          plhs[0] = sf_c3_testmodel_1109_jit_fallback_info();
          break;
        }
      }
     ...
     case 4:
      {
        if (strcmp(tpChksum, "sUYgwWq1d1sdy5xW3XbyWQH") == 0) {
          extern mxArray *sf_c4_testmodel_1109_jit_fallback_info(void);
          plhs[0] = sf_c4_testmodel_1109_jit_fallback_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "sfwpEfgroDabeJuY5NfKlDH") == 0) {
          extern mxArray *sf_c3_testmodel_1109_updateBuildInfo_args_info(void);
          plhs[0] = sf_c3_testmodel_1109_updateBuildInfo_args_info();
          break;
        }
      }
     ...
     case 4:
      {
        if (strcmp(tpChksum, "sUYgwWq1d1sdy5xW3XbyWQH") == 0) {
          extern mxArray *sf_c4_testmodel_1109_updateBuildInfo_args_info(void);
          plhs[0] = sf_c4_testmodel_1109_updateBuildInfo_args_info();
          break;
        }
      }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  switch (chartFileNumber) {
   case 3:
    {
      if (strcmp(tpChksum, "sfwpEfgroDabeJuY5NfKlDH") == 0) {
        extern mxArray *sf_c3_testmodel_1109_get_post_codegen_info(void);
        plhs[0] = sf_c3_testmodel_1109_get_post_codegen_info();
        return;
      }
    }
    break;
   ...
   case 4:
    {
      if (strcmp(tpChksum, "sUYgwWq1d1sdy5xW3XbyWQH") == 0) {
        extern mxArray *sf_c4_testmodel_1109_get_post_codegen_info(void);
        plhs[0] = sf_c4_testmodel_1109_get_post_codegen_info();
        return;
      }
    }
    break;

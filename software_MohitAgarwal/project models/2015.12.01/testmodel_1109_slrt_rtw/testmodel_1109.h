...
typedef struct {
  ...
  real_T Step;                         /* '<S5>/Step' */
  real_T CANUnpack1_o1;                /* '<S27>/CAN Unpack1' */
  real_T CANUnpack1_o2;                /* '<S27>/CAN Unpack1' */
  real_T CANUnpack1_o3;                /* '<S27>/CAN Unpack1' */
  real_T CANUnpack1_o4;                /* '<S27>/CAN Unpack1' */
  real_T Uk1;                          /* '<S28>/Delay Input1' */
  real_T Counter_o1;                   /* '<S27>/Counter' */
  real_T Constant1;                    /* '<S20>/Constant1' */
  real_T Constant;                     /* '<S19>/Constant' */
  real_T Constant1_n;                  /* '<S18>/Constant1' */
  real_T Constant_d;                   /* '<S4>/Constant' */
  real_T SendVel;                      /* '<S3>/SendVel' */
  ...
  int32_T state[2];                    /* '<S22>/MATLAB Function1' */
  int32_T vel;                         /* '<S14>/MATLAB Function1' */
  int32_T y;                           /* '<S3>/MATLAB Function' */
  uint32_T cur;                        /* '<S14>/MATLAB Function1' */
  int32_T DiscreteTimeIntegrator;      /* '<S1>/Discrete-Time Integrator' */
  int8_T ForIterator;                  /* '<S22>/For Iterator' */
  uint8_T CANUnpack2[8];               /* '<S22>/CAN Unpack2' */
  uint8_T CANUnpack3[7];               /* '<S22>/CAN Unpack3' */
  uint8_T y_e[4];                      /* '<S14>/TC UI32-UI8' */
  boolean_T Counter;                   /* '<S1>/Counter' */
  boolean_T FixPtRelationalOperator;   /* '<S28>/FixPt Relational Operator' */
  boolean_T Counter_o2;                /* '<S27>/Counter' */
  boolean_T HiddenBuf_InsertedFor_JKFlipFlo;
  boolean_T TmpLatchAtJKFlipFlopInport1;
  boolean_T TmpLatchAtJKFlipFlopInport2;
  boolean_T Memory;                    /* '<S15>/Memory' */
  boolean_T Logic[2];                  /* '<S15>/Logic' */
...
typedef struct {
  ...
  real_T pos[4];                       /* '<S22>/MATLAB Function1' */
  real_T vel[4];                       /* '<S22>/MATLAB Function1' */
  ...
  uint32_T Counter_Count;              /* '<S27>/Counter' */
  uint32_T Counter_ClkEphState_g;      /* '<S27>/Counter' */
  ...
  int_T CANUnpack2_ModeSignalID;       /* '<S22>/CAN Unpack2' */
  int_T CANUnpack2_StatusPortID;       /* '<S22>/CAN Unpack2' */
  int_T CANUnpack3_ModeSignalID;       /* '<S22>/CAN Unpack3' */
  int_T CANUnpack3_StatusPortID;       /* '<S22>/CAN Unpack3' */
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_h;                 /* '<S29>/S-Function' */

  int_T CANUnpack1_ModeSignalID;       /* '<S27>/CAN Unpack1' */
  int_T CANUnpack1_StatusPortID;       /* '<S27>/CAN Unpack1' */
  int_T CANPack_ModeSignalID;          /* '<S20>/CAN Pack' */
  int_T Writev3_IWORK[4];              /* '<S20>/Write (v3)' */
  int_T CANPack_ModeSignalID_e;        /* '<S19>/CAN Pack' */
  int_T Writev3_IWORK_d[4];            /* '<S19>/Write (v3)' */
  int_T CANPack2_ModeSignalID;         /* '<S18>/CAN Pack2' */
  int_T Writev3_IWORK_p[4];            /* '<S18>/Write (v3)' */
  int_T CANPack1_ModeSignalID;         /* '<S4>/CAN Pack1' */
  int_T CANPack_ModeSignalID_b;        /* '<S4>/CAN Pack' */
  int_T Writev3_IWORK_l[4];            /* '<S4>/Write (v3)' */
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_i;                 /* '<S13>/S-Function' */

  int_T CANPack1_ModeSignalID_c;       /* '<S14>/CAN Pack1' */
  int_T CANPack2_ModeSignalID_p;       /* '<S14>/CAN Pack2' */
  int_T Writev3_IWORK_d5[4];           /* '<S3>/Write (v3)' */
  int_T CANPack2_ModeSignalID_j;       /* '<S12>/CAN Pack2' */
  int_T Writev31_IWORK[4];             /* '<S3>/Write (v3)1' */
  int_T CANPack2_ModeSignalID_k;       /* '<S9>/CAN Pack2' */
...
typedef struct {
  ...
  ZCSigState JKFlipFlop_Trig_ZCE;      /* '<S10>/J-K Flip-Flop' */
...
struct P_testmodel_1109_T_ {
  ...
  boolean_T TmpLatchAtJKFlipFlopInport2_X0;/* Computed Parameter: TmpLatchAtJKFlipFlopInport2_X0
                                            * Referenced by: synthesized block
                                            */
  boolean_T ACK_TS_Y0;                 /* Computed Parameter: ACK_TS_Y0
 ...
 * '<S7>'   : 'testmodel_1109/IO601/Scope '
 * '<S8>'   : 'testmodel_1109/IO601/Scope 2'
 * '<S9>'   : 'testmodel_1109/IO601/CANSend/GetState (once)'
 * '<S10>'  : 'testmodel_1109/IO601/CANSend/J-K Flip-Flop1'
 * '<S11>'  : 'testmodel_1109/IO601/CANSend/MATLAB Function'
 * '<S12>'  : 'testmodel_1109/IO601/CANSend/STOP'
 * '<S13>'  : 'testmodel_1109/IO601/CANSend/Scope '
 * '<S14>'  : 'testmodel_1109/IO601/CANSend/movVel'
 * '<S15>'  : 'testmodel_1109/IO601/CANSend/J-K Flip-Flop1/J-K Flip-Flop'
 * '<S16>'  : 'testmodel_1109/IO601/CANSend/movVel/MATLAB Function1'
 * '<S17>'  : 'testmodel_1109/IO601/CANSend/movVel/TC UI32-UI8'
 * '<S18>'  : 'testmodel_1109/IO601/Initialize/GetState(ms)'
 * '<S19>'  : 'testmodel_1109/IO601/Initialize/InitialPosition'
 * '<S20>'  : 'testmodel_1109/IO601/Initialize/QuitError'
 * '<S21>'  : 'testmodel_1109/IO601/ReadQueueSS/Counter Free-Running'
 * '<S22>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem'
 * '<S23>'  : 'testmodel_1109/IO601/ReadQueueSS/MATLAB Function'
 * '<S24>'  : 'testmodel_1109/IO601/ReadQueueSS/Counter Free-Running/Increment Real World'
 * '<S25>'  : 'testmodel_1109/IO601/ReadQueueSS/Counter Free-Running/Wrap To Zero'
 * '<S26>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/MATLAB Function1'
 * '<S27>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/ReadACK'
 * '<S28>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/ReadACK/Detect Increase'
 * '<S29>'  : 'testmodel_1109/IO601/ReadQueueSS/For Iterator Subsystem/ReadACK/Scope 3'
 */

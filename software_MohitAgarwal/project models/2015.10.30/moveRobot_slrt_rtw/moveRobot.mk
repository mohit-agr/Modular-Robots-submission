...
MODEL           = moveRobot
MODULES         = can_datatype_ground.c moveRobot_capi.c moveRobot_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = moveRobot.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\1SMARTe\Desktop\TESTMO~1\mohit\201510~1.30
S_FUNCTIONS     = sg_IO601_write_s_3.c sg_IO601_setup_s_3.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 0
...
MODELLIB                  = moveRobotlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = moveRobot_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\moveRobot_slrt_rtw
